...
export const ApiKeyRepository = {
  ...
  findByAccessKeyId: (apiAccessKeyId: string) => prisma.apiKey.findUnique({ where: { accessKeyId: apiAccessKeyId } }),
  ...
  updateLimitsByApiAccessKeyId: (apiAccessKeyId: string, totalStorage: bigint, totalObjects: number) =>
    prisma.apiKey.update({
      where: { accessKeyId: apiAccessKeyId },
      data: {
        totalStorage,
        totalObjects,
      },
